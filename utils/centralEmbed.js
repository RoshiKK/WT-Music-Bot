...
class CentralEmbedHandler {
    ...
    async createCentralEmbed(channelId, guildId) {
        try {
            ...
            .setAuthor({ name: 'Witchers Music Control Center', iconURL: 'https://cdn.discordapp.com/emojis/896724352949706762.gif', url: 'https://discord.gg/xQF9f9yUEM' })
                .setDescription([
                    '',
                ...
                .setFooter({ 
                    text: 'Witchers Music Bot • Developed By revolution!',
        ...
        try {
            ...
            if (trackInfo) {
                ...
                embed = new EmbedBuilder()
                    ...
                    .setColor(embedColor)
                    .setFooter({ 
                        text: `Witchers Music Bot • ${statusText} • Developed By revolution`,
                        iconURL: this.client.user.displayAvatarURL()
                    })
                    .setTimestamp();
